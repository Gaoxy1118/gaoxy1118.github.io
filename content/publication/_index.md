...
<div class="pub-list" id="publicationList">
    ...
    <!-- ================================================================================== -->
    {{< publication_item
        title=" Integrated modeling and economic assessment of hydrogen storage with wellbore-reservoir-thermo-hydro-mechanical-diffusion coupling"
        year="2026"
        type="journal"
    ...
    {{< /publication_item >}}
    {{< publication_item
        title="An integrated deep learning framework for full-cycle CCUS-EOR evaluation and optimization under carbon neutrality"
        year="2026"
        type="journal"
        tags="ai,denoising"
        search="self-supervised denoising"
        authors="Bin Shen, Shenglai Yang*, Yiqi Zhang, <span class='author-me'>Xinyuan Gao</span>, Lufei Bi, Kai Du, Ermeng Zhao, Hongbo Zeng*"
        venue="Petroleum Science"
        meta="<span><i class='fas fa-calendar'></i> 2026</span><span><i class='fas fa-book'></i> Pet. Sci.</span><span><i class='fas fa-star'></i> IF: 6.1</span><span><i class='fas fa-quote-right'></i> Citations: 0</span>"
        bibtexId="bib202601"
        bibtexKey="gu2026thz"
        bibtexContent="@article{gao2023influence,title={Influence of reservoir spatial heterogeneity on a multicoupling process of CO2 geological storage},author={Gao, Xinyuan and Yang, Shenglai and Shen, Bin and Tian, Lerao and Li, Shuai and Zhang, Xing and Wang, Jiatong},journal={Energy \& Fuels},volume={37},number={19},pages={14991--15005},year={2023},publisher={ACS Publications}}"
    >}}
    ...
    {{< publication_item
        ...
        meta="<span><i class='fas fa-calendar'></i> 2026</span><span><i class='fas fa-book'></i> Fuel</span><span><i class='fas fa-star'></i> IF: 7.5</span><span><i class='fas fa-quote-right'></i> Citations: 2</span>"
        bibtexId="bib202601"
        bibtexKey="gu2026thz"
        bibtexContent="@article{gao2023influence,title={Influence of reservoir spatial heterogeneity on a multicoupling process of CO2 geological storage},author={Gao, Xinyuan and Yang, Shenglai and Shen, Bin and Tian, Lerao and Li, Shuai and Zhang, Xing and Wang, Jiatong},journal={Energy \& Fuels},volume={37},number={19},pages={14991--15005},year={2023},publisher={ACS Publications}}"
    >}}
    ...
    {{< /publication_item >}}
    {{< publication_item
        title="A comprehensive study on huff-n-puff oil recovery in tight sedimentary tuff oil reservoirs"
        year="2026"
        type="journal"
        tags="ai,denoising"
        search="self-supervised denoising"
        authors="Shuai Li, Hai Huang*, Junbin Chen, Shenglai Yang*, Ermeng Zhao, <span class='author-me'>Xinyuan Gao</span>, Bin Shen, Yubo Liu, Xiangrong Nie, Zhiguo Wang*"
        meta="<span><i class='fas fa-calendar'></i> 2026</span><span><i class='fas fa-book'></i>  International Journal of Coal Science & Technology</span><span><i class='fas fa-star'></i> IF: 8.7</span><span><i class='fas fa-quote-right'></i> Citations: 0</span>"
        bibtexId="bib202601"
        bibtexKey="gu2026thz"
        bibtexContent="@article{gao2023influence,title={Influence of reservoir spatial heterogeneity on a multicoupling process of CO2 geological storage},author={Gao, Xinyuan and Yang, Shenglai and Shen, Bin and Tian, Lerao and Li, Shuai and Zhang, Xing and Wang, Jiatong},journal={Energy \& Fuels},volume={37},number={19},pages={14991--15005},year={2023},publisher={ACS Publications}}"
    >}}
    ...
    {{< publication_item
        ...
        venue="Energy"
        venueStyle="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;"
        meta="<span><i class='fas fa-calendar'></i> 2025</span><span><i class='fas fa-book'></i>Energy</span><span><i class='fas fa-star'></i> IF: 9.4</span><span><i class='fas fa-quote-right'></i> Citations: 37</span>"
        bibtexId="bib1"
        bibtexKey="gu2025enhancing"
        bibtexContent="@article{gu2025enhancing, title={Enhancing Biomedical Optical Volumetric Imaging via Self-Supervised Orthogonal Learning}, author={Gu, Yuanjie and Wang, Yiqun and Xuan, Ang and Wang, Jianping and Wang, Linyi and Zhang, Lei and Li, Xiaoran and Wu, Yao and Zhang, Jun and Lu, Zhi and Dong, Biqin}, journal={Science Advances}, year={2025}}"
    >}}
    ...
    {{< publication_item
        ...
        venueStyle="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;"
        meta="<span><i class='fas fa-calendar'></i> 2025</span><span><i class='fas fa-book'></i>J. Hydrol.</span><span><i class='fas fa-star'></i> IF:6.3</span><span><i class='fas fa-quote-right'></i> Citations:29</span>"
        bibtexId="bib2"
    ...
    {{< publication_item
        ...
        meta="<span><i class='fas fa-calendar'></i> 2025</span><span><i class='fas fa-book'></i> Gondwana Res.</span><span><i class='fas fa-star'></i> IF: 8.6</span><span><i class='fas fa-quote-right'></i> Citations: 9</span>"
        bibtexId="bib3"
    ...
    {{< publication_item
        ...
        venue="Petroleum Science"
        meta="<span><i class='fas fa-calendar'></i> 2025</span><span><i class='fas fa-book'></i> Pet. Sci.</span><span><i class='fas fa-star'></i> IF: 6.1</span><span><i class='fas fa-quote-right'></i> Citations: 60</span>"
        bibtexId="bib4"
    ...
    {{< publication_item
        ...
        meta="<span><i class='fas fa-calendar'></i> 2025</span><span><i class='fas fa-book'></i> Energy</span><span><i class='fas fa-star'></i> IF: 9.4</span><span><i class='fas fa-quote-right'></i> Citations: 17</span>"
        bibtexId="bib13"
    ...
    <!-- ================================================================================== -->
    {{< publication_item
        title="System and multi-physics coupling model of liquid-CO<sub>2</sub> injection on CO<sub>2</sub> storage with enhanced gas recovery (CSEGR) framework"
        year="2024"
        type="journal"
        tags="ai,microscopy, selected"
        award="连续九期ESI高被引论文"
        search="single-molecule localization microscopy denoising"
        authors="<span class='author-me'>Xinyuan Gao</span>, Shenglai Yang*, Lerao Tian, Bin Shen, Lufei Bi, Yiqi Zhang, Mengyu Wang, Zhenhua Rui*"
        venue="Energy"
        meta="<span><i class='fas fa-calendar'></i> 2024</span><span><i class='fas fa-book'></i> Energy</span><span><i class='fas fa-star'></i> IF: 9.4</span><span><i class='fas fa-quote-right'></i> Citations: 56</span>"
        bibtexId="bib15"
    ...
    {{< /publication_item >}}
    {{< publication_item
        title="Effects of CO2 variable thermophysical properties and phase behavior on CO<sub>2</sub> geological storage: A numerical case study"
        year="2024"
        type="journal"
        tags="ai,imaging"
        search="super-resolution fluorescence microscopy physical priors"
        authors="<span class='author-me'>Xinyuan Gao</span>, Shenglai Yang*, Bin Shen, Jiatong Wang, Lerao Tian, Shuai Li*"
        venue="International Journal of Heat and Mass Transfer"
        meta="<span><i class='fas fa-calendar'></i> 2024</span><span><i class='fas fa-book'></i> Int. J. Heat Mass Transf.</span><span><i class='fas fa-star'></i> IF: 5.8</span><span><i class='fas fa-quote-right'></i> Citations: 29</span>"
        bibtexId="bib16"
    ...
    {{< /publication_item >}}
    {{< publication_item
        title="Interpretable causal-based temporal graph convolutional network framework in complex spatio-temporal systems for CCUS-EOR"
        year="2024"
        type="journal"
        tags="ai,imaging"
        search="super-resolution fluorescence microscopy physical priors"
        authors="Bin Shen*, Shenglai Yang*, Jiangtao Hu, Yiqi Zhang, Lingfeng Zhang, Shanlin Ye, Zhengze Yang, Jiayi Yu, <span class='author-me'>Xinyuan Gao</span>*, Ermeng Zhao*"
        venue="Energy"
        meta="<span><i class='fas fa-calendar'></i> 2024</span><span><i class='fas fa-book'></i> Energy</span><span><i class='fas fa-star'></i> IF: 9.4</span><span><i class='fas fa-quote-right'></i> Citations: 22</span>"
        bibtexId="bib16"
        bibtexKey="cai2024super"
        bibtexContent="@article{cai2024super, title={Super Resolution Reconstruction of Fluorescence Microscopy Image by Convolutional Network with Physical Priors}, author={Cai, Qiangyu and Lu, Jun and Gu, Wenting and Xiao, Di and Li, Boyi and Xu, Lei and Gu, Yuanjie and Dong, Biqin and Liu, Xin}, journal={Biomedical Optics Express}, volume={15}, number={11}, pages={6638-6653}, year={2024}}"
    >}}
    ...
    {{< /publication_item >}}
    {{< publication_item
        title="Enhanced Gas Recovery Coupled with CO<sub>2</sub> Sequestration in Tight Sandstone Reservoirs with Different Pore-Throat Structures"
        year="2024"
        type="journal"
        tags="ai,imaging"
        search="super-resolution fluorescence microscopy physical priors"
        authors="Jiangtao Hu, Shenglai Yang*, Kun Yang, Hui Deng, Mengyu Wang, Jiajun Li, <span class='author-me'>Xinyuan Gao</span>*"
        venue="Energy & Fuels"
        meta="<span><i class='fas fa-calendar'></i> 2024</span><span><i class='fas fa-book'></i> Energy Fuels</span><span><i class='fas fa-star'></i> IF: 5.3</span><span><i class='fas fa-quote-right'></i> Citations: 15</span>"
        bibtexId="bib16"
        bibtexKey="cai2024super"
        bibtexContent="@article{cai2024super, title={Super Resolution Reconstruction of Fluorescence Microscopy Image by Convolutional Network with Physical Priors}, author={Cai, Qiangyu and Lu, Jun and Gu, Wenting and Xiao, Di and Li, Boyi and Xu, Lei and Gu, Yuanjie and Dong, Biqin and Liu, Xin}, journal={Biomedical Optics Express}, volume={15}, number={11}, pages={6638-6653}, year={2024}}"
    >}}
    ...
    {{< /publication_item >}}
    {{< publication_item
        title="Study on Engineering Parameters and Risks of CO2 Geological Storage Based on WR-THM Coupling Model"
        year="2024"
        type="Conference"
        tags="ai,imaging"
        search="super-resolution fluorescence microscopy physical priors"
        authors="<span class='author-me'>Xinyuan Gao</span>, Shenglai Yang, Jiatong Wang, Lerao Tian, Lufei Bi, Haiwei Zuo, Bin Shen"
        venue="International Conference on Applied Energy"
        meta="<span><i class='fas fa-calendar'></i> 2024</span><span><i class='fas fa-book'></i> ICAE</span><span><i class='fas fa-quote-right'></i> Citations: 0</span>"
        bibtexId="bib16"
        bibtexKey="cai2024super"
        bibtexContent="@article{cai2024super, title={Super Resolution Reconstruction of Fluorescence Microscopy Image by Convolutional Network with Physical Priors}, author={Cai, Qiangyu and Lu, Jun and Gu, Wenting and Xiao, Di and Li, Boyi and Xu, Lei and Gu, Yuanjie and Dong, Biqin and Liu, Xin}, journal={Biomedical Optics Express}, volume={15}, number={11}, pages={6638-6653}, year={2024}}"
    >}}
    ...
    {{< /publication_item >}}
    {{< publication_item
        title="Study on the influence of steam state on seepage, production, migration and deposition of offshore heavy oilfields"
        year="2024"
        type="journal"
        tags="ai,imaging"
        search="super-resolution fluorescence microscopy physical priors"
        authors="Yiqi Zhang, Hao Chen*, Zuhao Zheng, Shenglai Yang, Xiliang Liu, Mingsheng Zuo, <span class='author-me'>Xinyuan Gao</span>"
        venue="Energy"
        meta="<span><i class='fas fa-calendar'></i> 2024</span><span><i class='fas fa-book'></i> Energy</span><span><i class='fas fa-star'></i> IF: 4.6</span><span><i class='fas fa-quote-right'></i> Citations: 10</span>"
        bibtexId="bib16"
        bibtexKey="cai2024super"
        bibtexContent="@article{cai2024super, title={Super Resolution Reconstruction of Fluorescence Microscopy Image by Convolutional Network with Physical Priors}, author={Cai, Qiangyu and Lu, Jun and Gu, Wenting and Xiao, Di and Li, Boyi and Xu, Lei and Gu, Yuanjie and Dong, Biqin and Liu, Xin}, journal={Biomedical Optics Express}, volume={15}, number={11}, pages={6638-6653}, year={2024}}"
    >}}
    ...
    {{< /publication_item >}}
    {{< publication_item
        title="Effect of pore structure characteristics on gas-water seepage behaviour in deep carbonate gas reservoirs"
        year="2024"
        type="journal"
        tags="ai,imaging"
        search="super-resolution fluorescence microscopy physical priors"
        authors="Jiangtao Hu, Shenglai Yang*, Beidong Wang, Hui Deng, Mengyu Wang, Jiajun Li, Shuai Zhao, Bin Shen*, <span class='author-me'>Xinyuan Gao</span>, Kun Yang"
        venue="Geoenergy Science and Engineering"
        meta="<span><i class='fas fa-calendar'></i> 2024</span><span><i class='fas fa-book'></i> Geoenergy Sci. Eng.</span><span><i class='fas fa-star'></i> IF: 4.6</span><span><i class='fas fa-quote-right'></i> Citations: 31</span>"
        bibtexId="bib16"
        bibtexKey="cai2024super"
        bibtexContent="@article{cai2024super, title={Super Resolution Reconstruction of Fluorescence Microscopy Image by Convolutional Network with Physical Priors}, author={Cai, Qiangyu and Lu, Jun and Gu, Wenting and Xiao, Di and Li, Boyi and Xu, Lei and Gu, Yuanjie and Dong, Biqin and Liu, Xin}, journal={Biomedical Optics Express}, volume={15}, number={11}, pages={6638-6653}, year={2024}}"
    >}}
    ...
    {{< /publication_item >}}
    {{< publication_item
        title="Application of Heterogeneous Ensemble Learning for CO<sub>2</sub>–Brine Interfacial Tension Prediction: Implications for CO2 Storage"
        year="2024"
        type="journal"
        tags="ai,imaging"
        search="super-resolution fluorescence microscopy physical priors"
        authors="Bin Shen, Shenglai Yang*, Jiangtao Hu, Yumeng Gao, Hang Xu, <span class='author-me'>Xinyuan Gao</span>, Hao Chen*"
        venue="Energy & Fuels"
        meta="<span><i class='fas fa-calendar'></i> 2024</span><span><i class='fas fa-book'></i> Energy Fuels</span><span><i class='fas fa-star'></i> IF: 5.3</span><span><i class='fas fa-quote-right'></i> Citations: 12</span>"
        bibtexId="bib16"
        bibtexKey="cai2024super"
        bibtexContent="@article{cai2024super, title={Super Resolution Reconstruction of Fluorescence Microscopy Image by Convolutional Network with Physical Priors}, author={Cai, Qiangyu and Lu, Jun and Gu, Wenting and Xiao, Di and Li, Boyi and Xu, Lei and Gu, Yuanjie and Dong, Biqin and Liu, Xin}, journal={Biomedical Optics Express}, volume={15}, number={11}, pages={6638-6653}, year={2024}}"
    >}}
    ...
    <!-- ================================================================================== -->
    {{< publication_item
        title="Influence of Reservoir Spatial Heterogeneity on a Multicoupling Process of CO<sub>2</sub> Geological Storage"
        year="2023"
        type="journal"
        tags="ai,segmentation"
        search="multimodal volumetric segmentation lesion awareness"
        authors="<span class='author-me'>Xinyuan Gao</span>, Shenglai Yang*, Bin Shen, Lerao Tian, Shuai Li, Xing Zhang, Jiatong Wang*"
        venue="Energy & Fuels"
        meta="<span><i class='fas fa-calendar'></i> 2023</span><span><i class='fas fa-book'></i> Energy Fuels</span><span><i class='fas fa-star'></i> IF: 5.3</span><span><i class='fas fa-quote-right'></i> Citations: 29</span>"
        bibtexId="bib5"
    ...
    {{< /publication_item >}}
    {{< publication_item
        title="Integration of Domain Knowledge and Data-Driven Modeling Evaluation Process for Predicting Minimum Miscible Pressure of CO<sub>2</sub>–Oil Systems in CCUS"
        year="2023"
        type="journal"
        tags="ai,image fusion"
        search="infrared visible image fusion retinex"
        authors="Xing Zhang, Hang Xu*, Kunjuan Wang, Shenglai Yang, Bin Shen, Ruiming Zhao, Huiying Guo, Yuankai Zhang, <span class='author-me'>Xinyuan Gao</span>"
        venue="Energy & Fuels"
        meta="<span><i class='fas fa-calendar'></i> 2023</span><span><i class='fas fa-book'></i> Energy Fuels</span><span><i class='fas fa-star'></i> IF: 5.3</span><span><i class='fas fa-quote-right'></i> Citations: 8</span>"
        bibtexId="bib7"
    ...
    {{< /publication_item >}}
    {{< publication_item
        title="A novel CO<sub>2</sub>-EOR potential evaluation method based on BO-LightGBM algorithms using hybrid feature mining"
        year="2023"
        type="journal"
        tags="ai,imaging"
        search="space-bandwidth product limit cycle constraint"
        authors="Bin Shen, Shenglai Yang*, <span class='author-me'>Xinyuan Gao</span>, Shuai Li, Shuangshuang Ren, Hao Chen*"
        venue="Geoenergy Science and Engineering"
        meta="<span><i class='fas fa-calendar'></i> 2023</span><span><i class='fas fa-book'></i> Geoenergy Sci. Eng.</span><span><i class='fas fa-star'></i> IF: 4.6</span><span><i class='fas fa-quote-right'></i> Citations: 34</span>"
        bibtexId="bib10"
    ...
    {{< /publication_item >}}
    {{< publication_item
        title="Interpretable knowledge-guided framework for modeling minimum miscible pressure of CO<sub>2</sub>-oil system in CO<sub>2</sub>-EOR projects"
        year="2023"
        type="journal"
        tags="ai,imaging"
        search="fluorescence imaging global enhancement deep learning"
        authors="Bin Shen, Shenglai Yang*, <span class='author-me'>Xinyuan Gao</span>, Shuai Li*, Kun Yang, Jiangtao Hu, Hao Chen"
        venue="Engineering Applications of Artificial Intelligence"
        meta="<span><i class='fas fa-calendar'></i> 2023</span><span><i class='fas fa-book'></i> Eng. Appl. Artif. Intell.</span><span><i class='fas fa-star'></i> IF: 8.0</span><span><i class='fas fa-quote-right'></i> Citations: 48</span>"
        bibtexId="bib12"
    ...
    <!-- ================================================================================== -->
    {{< publication_item
        title="Experimental study on liquid production law, oil recovery mechanism, and influencing factors of water huff-n-puff in the tight sedimentary tuff oil reservoir"
        year="2022"
        type="journal"
        tags="ai,imaging"
        search="fluorescence imaging enhancement low-excitation"
        authors="Shuai Li, Shenglai Yang*, <span class='author-me'>Xinyuan Gao</span>, Mibang Wang*, Jiayi Yu"
        venue="Journal of Petroleum Science and Engineering"
        meta="<span><i class='fas fa-calendar'></i> 2022</span><span><i class='fas fa-book'></i> J. Pet. Sci. Eng.</span><span><i class='fas fa-star'></i> IF: 4.6</span><span><i class='fas fa-quote-right'></i> Citations: 24</span>"
        bibtexId="bib6"
    ...
    {{< /publication_item >}}
    {{< publication_item
        title="Characteristics and mechanism of imbibition oil recovery in the ultra-low-permeability volcanic oil reservoir in the Santanghu Basin"
        year="2022"
        type="journal"
        tags="ai,imaging"
        search="plenoptic super-resolution all-in-focus imaging"
        authors="Shuai Li*, Shenglai Yang*, <span class='author-me'>Xinyuan Gao</span>, Mengyu Wang, Bin Shen, Jiayi Yu"
        venue="Colloids and Surfaces A: Physicochemical and Engineering Aspects"
        meta="<span><i class='fas fa-calendar'></i> 2022</span><span><i class='fas fa-book'></i> Colloids Surf. A Physicochem. Eng. Asp.</span><span><i class='fas fa-star'></i> IF: 5.4</span><span><i class='fas fa-quote-right'></i> Citations: 10</span>"
        bibtexId="bib8"
    ...
    {{< /publication_item >}}
    {{< publication_item
        title="应用径向流产能模拟法确定超深层碳酸盐岩气藏储层物性下限——以高石梯-磨溪区块为例"
        year="2022"
        type="journal"
        tags="software,imaging"
        search="light field refocusing open-source"
        authors="张钰祥, 杨胜来*, 王蓓东, 李强, <span class='author-me'>高鑫远</span>, 邓惠, 鄢友军, 陈掌星"
        meta="<span><i class='fas fa-calendar'></i> 2022</span><span><i class='fas fa-book'></i> 大庆石油地质与开发</span><span><i class='fas fa-star'></i> IF: 3.3</span><span><i class='fas fa-quote-right'></i> Citations: 12</span>"
        bibtexId="bib9"
    ...
    {{< /publication_item >}}
    {{< publication_item
        title="三塘湖盆地致密沉凝灰岩储层孔隙结构及流体可动性特征"
        year="2022"
        type="journal"
        tags="ai,medical"
        search="blood cell analysis multi-modal imaging deep learning"
        authors="李帅, 杨胜来, 王爽, <span class='author-me'>高鑫远</span>, 张政, 焦宝, 于家义"
        meta="<span><i class='fas fa-calendar'></i> 2022</span><span><i class='fas fa-book'></i> 西安石油大学学报(自然科学版)</span><span><i class='fas fa-star'></i> IF: 1.7</span><span><i class='fas fa-quote-right'></i> Citations: 8</span>"
        bibtexId="bib17"
    ...
    <!-- ================================================================================== -->
    {{< publication_item
        title="Influencing Factors and Construction Parameter Optimization Design of Hot Water Huff and Puff in Tight Volcanic Reservoir"
        year="2021"
        type="Conference"
        tags="ai,imaging"
        search="super-resolution fluorescence microscopy physical priors"
        authors="Shuai Li, Shenglai Yang*, <span class='author-me'>Xinyuan Gao</span>, Wengang Dong, Lei Jin, Beidong Wang"
        venue="International Conference on Applied Energy"
        meta="<span><i class='fas fa-calendar'></i> 2021</span><span><i class='fas fa-book'></i> ICAE</span><span><i class='fas fa-quote-right'></i> Citations: 0</span>"
        bibtexId="bib16"
        bibtexKey="cai2024super"
        bibtexContent="@article{cai2024super, title={Super Resolution Reconstruction of Fluorescence Microscopy Image by Convolutional Network with Physical Priors}, author={Cai, Qiangyu and Lu, Jun and Gu, Wenting and Xiao, Di and Li, Boyi and Xu, Lei and Gu, Yuanjie and Dong, Biqin and Liu, Xin}, journal={Biomedical Optics Express}, volume={15}, number={11}, pages={6638-6653}, year={2024}}"
    >}}
